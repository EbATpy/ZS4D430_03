CLASS zcl_03_check_and_fill DEFINITION PUBLIC
 FINAL
 CREATE PUBLIC.
...
CLASS ZCL_03_CHECK_AND_FILL IMPLEMENTATION.
...
*
    CONSTANTS c_employ_table  TYPE tabname VALUE 'Z03EMPLOY'.
    CONSTANTS c_depment_table TYPE tabname VALUE 'Z03DEPMENT'.
